...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press on the start button or no more playtime ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function startGame(){
  GameStatus="start";
  document.getElementById("status").innerHTML="Game is loading please be patient do not run of anywhere";
}
